...
<li ${fn:contains(reqPath,"/admin/cate")?"class='active'":""}>
    ...
    <ul id="cate" class="nav nav-list secondmenu ${fn:contains(reqPath,'/admin/cate')?'':'collapse'}" style="height: auto;">
    	<li><a href="${pageContext.request.contextPath}/admin/addCate"><i class="glyphicon glyphicon-plus"></i>&nbsp;添加商品分类</a></li>
	    <li><a href="${pageContext.request.contextPath}/admin/getAdminCates"><i class="glyphicon glyphicon-list"></i>&nbsp;查看商品分类</a></li>
    </ul>
</li>
